...
resume_path = '/yuch_ws/3DGEN/ControlNet-v1-1-nightly/models/control_sd15_canny.pth'  # conv 1


# # First use cpu to load models. Pytorch Lightning will automatically move it to GPUs.
model = create_model('/yuch_ws/3DGEN/ControlNet-v1-1-nightly/models/yuch_v11p_sd15_canny.yaml').cpu()
